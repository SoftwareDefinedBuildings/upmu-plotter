...
function createPermalink(self) {
    var permalink = 'streams=' + $.map(self.idata.selectedStreams, function (d) { return encodeURIComponent(JSON.stringify(d)) + "_" + self.idata.streamSettings[d.uuid].color; }).join(',');
